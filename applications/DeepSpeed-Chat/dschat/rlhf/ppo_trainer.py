...
from dschat.utils.report_util import reportStatistic
...
class DeepSpeedPPOTrainer():
    ...
    def _generate_sequence(self, prompts, mask, step):
        ...
        t1 = time.time()
        dt = t1 - t0
        reportStatistic("generate-experience",dt)
    ...
    def generate_experience(self, prompts, mask, step):
        ...
        with torch.no_grad():
            ...
            t1 = time.time()
            dt = t1 - t0
            reportStatistic("actor-inference",dt)
            
            t0 = time.time()
            output_ref = self.ref_model(seq, attention_mask=attention_mask)
            t1 = time.time()
            dt = t1 - t0
            reportStatistic("ref-inference",dt)
            ...
            t1 = time.time()
            dt = t1 - t0
            reportStatistic("reward-inference",dt)
            ...
            t1 = time.time()
            dt = t1 - t0
            reportStatistic("critic-inference",dt)
    ...
    def train_rlhf(self, inputs):
        ...
        t1 = time.time()
        dt = t1 - t0
        reportStatistic("actor-train",dt)
        ...
        t1 = time.time()
        dt = t1 - t0
        reportStatistic("critic-train",dt)
